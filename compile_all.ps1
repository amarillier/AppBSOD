# PowerShell script to compile C and Go versions of BSOD application using MinGW GCC

Write-Host "Compiling C and Go versions of BSOD application using MinGW GCC..." -ForegroundColor Green

Write-Host "`nFIRST: Compiling C version of BSOD application using MinGW GCC..." -ForegroundColor Green
...
Write-Host "`nSECOND:Compiling Go version of BSOD application..." -ForegroundColor Green
